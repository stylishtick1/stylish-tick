...
export default function CustomerLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      <Header />
      <main className="container mx-auto px-4 md:px-6 lg:px-8 flex-1 bg-background text-foreground">
        {children}
      </main>
      <Footer />
      ...
      >
        ...
        <span className="max-w-0 overflow-hidden group-hover:max-w-xs group-hover:ml-2 transition-all duration-500 ease-in-out text-xs font-semibold uppercase tracking-wider whitespace-nowrap">
          Chat with Us
        </span>
      </a>
    </div>
